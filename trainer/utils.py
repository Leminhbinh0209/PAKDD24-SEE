...
class MultiTransforms:
    ...
    def __init__(self, mean_std, model, view=1, sz_crop=224):
        self.view = view
        self.model = model
        self.sz_crop = sz_crop
        ...
        self.transform = transforms.Compose([
            ...
            transforms.RandomResizedCrop(self.sz_crop, scale=self.scale, interpolation=transforms.InterpolationMode.BICUBIC),
...
def get_params_groups(model, sup_loss=None,  lr=1e-5, fc_lr_scale=1, weight_decay=0.01):
    """
